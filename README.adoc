...
* ou image::http://www.html5-css3.fr/wp-content/uploads/2011/01/html5-form-android-number.png
...
* audio
* video
* canvas image::http://www.alsacreations.com/xmedia/tuto/exemples/html5/html5canvas.jpg
* WebGL
